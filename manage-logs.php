...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from logs where id = '".$_GET['id']."'");
                  $_SESSION['delmsg']="log er deleted !!";
		  }
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($query)) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlentities($row['time_date']); ?></td>
                                                <td><?php echo htmlentities($row['location']); ?></td>
                                                <td><?php echo htmlentities($row['logstatus']); ?></td>
                                               
                                                <td class="action-btns">
                                                    
                                                    <a href="manage-logs.php?id=<?php echo $row['id']; ?>&del=delete" 
